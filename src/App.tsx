      ...
      <main className="flex-1 w-full px-4 sm:px-6 mx-auto flex flex-col overflow-y-auto pb-32 pt-3 md:pt-5">
        ...
        {activeTab === 'home' && (
          <div className="gap-3 md:gap-5 animate-fadeIn flex flex-col">
            ...
            <div className="flex flex-col gap-2.5 p-3 w-full md:grid md:grid-cols-3 md:gap-6 md:items-stretch md:p-0">

              {/* Card 1: AI Scan Prescription (Mobile: 3rd | Desktop: 1st) */}
              <div className="w-full h-auto md:h-full flex flex-col justify-between bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-3 md:p-8 shadow-xl order-3 md:order-1 md:col-start-1 md:row-start-1">
              ...
              <button
                ...
                className="text-left w-full h-auto md:h-full flex flex-col justify-between bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-3 md:p-8 shadow-xl cursor-pointer md:cursor-default hover:border-zinc-700 transition order-2 md:order-3 md:col-start-3 md:row-start-1"
              >
                <div>
              ...
              <div className="w-full h-auto md:h-full flex flex-col justify-between bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-3 md:p-8 shadow-xl order-1 md:order-2 md:col-start-2 md:row-start-1 relative z-20">
                <div>
